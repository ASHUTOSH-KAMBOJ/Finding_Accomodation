...
<body>
	<div id="Home-Container">
		<div class="Main-first">
			...
			<a href="./index.php" ><button id="Login-Signup" >Logout</button></a>
	...
	<div class="Searching">
		<div id="SeacrhBox">
			...
			<select class="DropBox" id="Category">
				<option value="Category" >Category.. </option>
				<option value="Flat">Flat </option>
				<option value="PG">PG </option>
				<option value="Hostel">Hostel </option>
			</select>
			<select class="DropBox" id="Type">
			...
			<br>
			<a href="Acco.php">
			<button type="button" class="search">Search</button></a>
	...
	<div class="mid-home">
		<div class="land">
			...
			<a href="./Sell.php" ><button id="Sell">Sell</button></a>
		</div>
